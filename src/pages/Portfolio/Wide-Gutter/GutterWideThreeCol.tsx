...
const GutterWideThreeCol = () => {
    ...
    const works = [
        ...
        { id: 6, category: 'design branding', classes: "work-lightbox-link mfp-image", title: 'Print Mockup', linkurl: full3, imageUrl: pro6, subTitle: "Lightbox" },
    ];
...
export default GutterWideThreeCol