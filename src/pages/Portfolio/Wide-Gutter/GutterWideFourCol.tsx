...
const GutterWideFourCol = () => {
    ...
    const works = [
        ...
        { id: 8, category: 'design branding', classes: "work-lightbox-link mfp-image", title: 'Young Man', linkurl: full3, imageUrl: pro8, subTitle: "Lightbox" },
    ];
...
export default GutterWideFourCol