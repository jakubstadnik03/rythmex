...
const WideTitleFiveCol = () => {
    ...
    const works = [
        ...
        { id: 10, category: 'design branding', classes: "work-lightbox-link mfp-image", title: 'Young Man', linkurl: full3, imageUrl: pro10, subTitle: "Lightbox" },
    ];
        ...
        <React.Fragment>
            ...
            <section className="page-section">
                <div className="relative">
                    ...
                    <ul className="works-grid work-grid-5 clearfix font-alt hover-white" id="work-grid">
...
export default WideTitleFiveCol