...
import sectionBg5 from "../../assets/images/full-width-images/section-bg-5.jpg"

const HeaderWhiteTransperant = () => {
    return (
        <React.Fragment>
            {/* hero */}
            <JarallaxSection
                backgroundImage={sectionBg5}
                className="home-section bg-light-alfa-30 parallax-2 fixed-height-small">
                        ...
                        <div className="home-text">
                            ...
                            <Row>
                                <Col md={8} className="align-left">
                                    <h1 className="hs-line-11 font-alt mb-20 mb-xs-0">Header White Transparent</h1>
...
export default HeaderWhiteTransperant