    ...
    return (
        <React.Fragment>
            <section
                ...
                className="page-section bg-light-alfa-30">
            ...
            <section className="page-section" id="about">
                <div className="container relative">
                    ...
                    <Row>
                        ...
                        <Col sm={4} className="mb-xs-30 wow fadeInUp">
                        ...
                        <Col sm={4} className="mb-xs-30 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="team-item">
                        ...
                        <Col sm={4} className="mb-xs-30 wow fadeInUp" data-wow-delay="0.2s">
                            <div className="team-item">
