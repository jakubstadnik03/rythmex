...
import pro15 from "../../../assets/images/portfolio/projects-15.jpg"
...
const TitleFourCol = () => {
    ...
    const works = [
        ...
        { id: 12, category: 'branding design', classes: "work-ext-link", title: 'Vase 3D', linkurl: "/profile-single-1", imageUrl: pro12, subTitle: "External Page" },
        { id: 13, category: 'branding', classes: "work-ext-link", title: 'Boy in T-shirt', linkurl: "/profile-single-1", imageUrl: pro13, subTitle: "External Page" },
        { id: 14, category: 'design photography', classes: "work-ext-link", title: 'Space', linkurl: "/profile-single-1", imageUrl: pro14, subTitle: "External Page" },
        { id: 15, category: 'design', classes: "work-ext-link", title: 'Model', linkurl: "/profile-single-1", imageUrl: pro15, subTitle: "External Page" },
        { id: 16, category: 'design branding', classes: "work-lightbox-link mfp-image", title: 'Young Man', linkurl: full3, imageUrl: pro1, subTitle: "Lightbox" },
    ];
            ...
            <section className="page-section">
                <div className="container relative">
                    <div className="works-filter font-alt align-center">
                        {/* Filter buttons */}
                        <Link to="#" onClick={() => handleFilterChange('all')} className="filter" role="button" aria-pressed="true" data-filter="*">All works</Link>
