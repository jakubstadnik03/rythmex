...
const MasonryFourCols = () => {
    ...
    const works = [
        { id: 1, category: 'photography', classes: "work-lightbox-link mfp-image", title: 'Portrait', linkurl: full1, imageUrl: pro7, subTitle: "Lightbox" },
        ...
        { id: 8, category: 'branding photography', classes: "work-ext-link", title: 'Space', linkurl: "/profile-single-1", imageUrl: pro10, subTitle: "External Page" },
        { id: 9, category: 'design branding', classes: "work-lightbox-link mfp-image", title: 'Young Man', linkurl: full3, imageUrl: pro8, subTitle: "Lightbox" },
        ...
        // { id: 7, category: 'design', classes: "work-ext-link", title: 'Model', linkurl: "/profile-single-1", imageUrl: proj7, subTitle: "External Page" },
    ];
        ...
        <React.Fragment>
            ...
            <section className="page-section" style={{paddingBottom: "0px"}}>
                <div className="relative">
                    ...
                    <ul className="works-grid clearfix font-alt hover-white hide-titles masonry" id="work-grid">
...
export default MasonryFourCols