...
import pro7 from "../../../assets/images/portfolio/masonry/projects-7.jpg"
import pro6 from "../../../assets/images/portfolio/masonry/projects-6.jpg"

const MasonryFiveCols = () => {
    ...
    const works = [
        ...
        { id: 6, category: 'design photography', classes: "work-ext-link", title: 'Space', linkurl: "/profile-single-1", imageUrl: pro5, subTitle: "External Page" },
        { id: 11, category: 'design photography', classes: "work-ext-link", title: 'Space', linkurl: "/profile-single-1", imageUrl: pro5, subTitle: "External Page" },
        { id: 7, category: 'design', classes: "work-ext-link", title: 'Model', linkurl: "/profile-single-1", imageUrl: pro7, subTitle: "External Page" },
        { id: 8, category: 'design photography', classes: "work-ext-link", title: 'Space', linkurl: "/profile-single-1", imageUrl: pro8, subTitle: "External Page" },
        { id: 10, category: 'branding photography', classes: "work-ext-link", title: 'Space', linkurl: "/profile-single-1", imageUrl: pro11, subTitle: "External Page" },
        { id: 9, category: 'design', classes: "work-ext-link", title: 'Model', linkurl: "/profile-single-1", imageUrl: pro9, subTitle: "External Page" },
        // { id: 12, category: 'design branding', classes: "work-lightbox-link mfp-image", title: 'Young Man', linkurl: full3, imageUrl: pro10, subTitle: "Lightbox" },
    ];
    ...
    <React.Fragment>
            ...
            <section className="page-section" style={{paddingBottom: "0px"}}>
                <div className="relative">
                    ...
                    <ul className="works-grid work-grid-5 clearfix font-alt hover-white hide-titles masonry" id="work-grid">
                        <Masonry columnsCount={5} gutter="0px">
...
export default MasonryFiveCols