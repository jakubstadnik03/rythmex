        ...
        <React.Fragment>
                ...
                <div className="relative container align-left">
                    ...
                    <Row>
                        ...
                        <Col md={8} className="col-md-8">
                            <h1 className="hs-line-11 font-alt mb-20 mb-xs-0">Portfolio Lazy-load</h1>
                        ...
                        <div className="col-md-4 mt-30">
                            <div className="mod-breadcrumbs font-alt align-right">
                                <Link to="#">Home</Link>&nbsp;/&nbsp;<Link to="#">Portfolio</Link>&nbsp;/&nbsp;<span>Boxed</span>
                            </div>
            ...
            <section className="page-section">
                <div className="container relative">
                    ...
                    <ul className="works-grid work-grid-3 work-grid-gut clearfix font-alt hover-white" id="work-grid">
