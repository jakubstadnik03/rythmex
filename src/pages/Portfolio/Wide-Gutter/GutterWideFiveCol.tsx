...
const GutterWideFiveCol = () => {
    ...
    const works = [
        ...
        { id: 15, category: 'design branding', classes: "work-lightbox-link mfp-image", title: 'Young Man', linkurl: full3, imageUrl: pro10, subTitle: "Lightbox" },
    ];
        ...
        <React.Fragment>
            ...
            <section className="page-section pb-0">
                <div className="relative">
                    ...
                    <ul className="works-grid work-grid-5 work-grid-gut clearfix font-alt hover-white hide-titles" id="work-grid">
...
export default GutterWideFiveCol